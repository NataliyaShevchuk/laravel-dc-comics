        ...
        <div class="col-12 mt-5 justify-content-center">
            <form  action=" {{route('comics.store') }} " class="row g-3" method="POST">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Date" name="sale_date">
                </div>
                <div class="col-12">
                    <label for="" class="form-label">Description</label>
                    <textarea type="text" class="form-control" id="" placeholder="Description" name="description"></textarea>
                </div>
                <div class="col-12">
                    <div class="mb-3">
